    ...
    return (
        <>
            ...
            <SafeAreaView className="flex-1 bg-background" edges={['top']}>
                ...
                {isSystem && (
                    <View
                        className="mx-4 mb-2 px-3 py-2 rounded-xl bg-orange-500/10 border border-orange-500/20"
                    >
                                ...
                                return (
                                    <View key={iconName} style={{ width: '16.666%', padding: 4 }}>
                                        <Pressable
                                            ...
                                            style={[
                                                isSelected ? { backgroundColor: hexToRgba(selectedColor, 0.15), borderWidth: 2, borderColor: selectedColor } : {}
                                            ]}
                                        >
                                            <Icon
                                                size={20}
                            ...
                            {CATEGORY_COLORS.map(color => (
                                <View key={color} style={{ width: '14.285%', padding: 4, alignItems: 'center' }}>
                                    <Pressable
                                        ...
                                        style={[{ backgroundColor: color }, isSystem ? { opacity: 0.5 } : {}]}
                                    >
                                        {selectedColor === color && (
